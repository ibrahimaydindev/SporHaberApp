...
import com.ibrahim.news_app.utils.Constants.Companion.QUERY_PAGE_SIZE
...
class NewsFragment : Fragment(R.layout.fragment_hbraks_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val binding = FragmentHbraksNewsBinding.bind(view)
    ...
    private fun hideProgressBar() {
        newsFragmentBinding.paginationProgressBar.visibility = View.INVISIBLE
        isLoading = false
    }

    private fun showProgressBar() {
        newsFragmentBinding.paginationProgressBar.visibility = View.VISIBLE
        isLoading = true
    }
    ...
    private fun setupRecyclerView() {
        ...
        newsFragmentBinding.rvBreakingNews.apply {
            adapter = newsAdapter
